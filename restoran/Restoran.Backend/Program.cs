...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Restoran Backend API", Version = "v1" });
...
builder.Services.AddDbContext<BackendDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("BackendDb")));
...
{
    app.MapGet("/export-swagger", async (Microsoft.AspNetCore.Mvc.ApiExplorer.IApiDescriptionGroupCollectionProvider _, Swashbuckle.AspNetCore.Swagger.ISwaggerProvider swaggerProvider) =>
    {
