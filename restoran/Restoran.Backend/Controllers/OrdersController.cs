...
public class OrdersController : ControllerBase
{
    ...
    /// <summary>Оформить заказ из корзины</summary>
    [HttpPost]
    ...
    /// <summary>История заказов с пагинацией</summary>
    [HttpGet("history")]
    ...
    /// <summary>Текущий активный заказ</summary>
    [HttpGet("current")]
    ...
    /// <summary>Повторить прошлый заказ (добавить блюда в корзину)</summary>
    [HttpPost("{id}/repeat")]
