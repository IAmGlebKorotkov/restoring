...
public class DishesController : ControllerBase
{
    ...
    /// <summary>Список блюд ресторана с фильтрацией и сортировкой</summary>
    ...
    /// <summary>Создать блюдо (Manager)</summary>
    ...
    /// <summary>Обновить блюдо (Manager)</summary>
    ...
    /// <summary>Удалить блюдо (Manager)</summary>
    ...
    /// <summary>Список категорий блюд</summary>
    [HttpGet("categories")]
    ...
    /// <summary>Получить рейтинг блюда</summary>
    ...
    /// <summary>Выставить оценку блюду (Customer)</summary>
    ...
    /// <summary>Удалить свою оценку блюда (Customer)</summary>
