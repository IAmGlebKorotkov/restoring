...
/// <summary>Эндпоинты для повара</summary>
[ApiController]
[Route("api/cook")]
...
public class CookController : ControllerBase
{
    ...
    /// <summary>Заказы со статусом Created в своем ресторане</summary>
    [HttpGet("orders")]
    ...
    /// <summary>Взять заказ на кухню (Created -> Kitchen)</summary>
    ...
    /// <summary>Упаковать заказ (Kitchen -> Packaging)</summary>
...
/// <summary>Эндпоинты для менеджера</summary>
[ApiController]
[Route("api/manager")]
...
public class ManagerController : ControllerBase
{
    ...
    /// <summary>Все заказы ресторана с фильтрацией</summary>
    [HttpGet("orders")]
...
/// <summary>Эндпоинты для курьера</summary>
[ApiController]
[Route("api/courier")]
...
public class CourierController : ControllerBase
{
    ...
    /// <summary>Доступные заказы для доставки (статус Packaging)</summary>
    [HttpGet("orders")]
    ...
    /// <summary>Отметить заказ доставленным (Delivery -> Delivered)</summary>
