...
public class AuthController : ControllerBase
{
    ...
    /// <summary>Обновление access token через refresh token</summary>
    [HttpPost("refresh")]
    ...
    /// <summary>Обновление своего профиля</summary>
    [HttpPut("profile")]
    [Authorize]
    ...
    /// <summary>Получить пользователя по ID (internal)</summary>
    [HttpGet("users/{id}")]
    [Authorize]
